...
function init() {
    ...
    var boxArray = [
        [12, 17, 4, -70, 2, 5, 0, "<%= escape_javascript museum_exhibition_url(@museum, @exhibition)%>" + "/artworks/379/"],
        [20, 20, 5, 70, 15, 5, 0.26, 'http://localhost:3000/museums/33/exhibitions/78/artworks/380/']
    ];
